...
namespace ServicoDeEsterelizacao.Controllers
{
    public class DiretorServicoesController : Controller
    {
        ...
        public DiretorServicoesController(ColaboradorDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("DiretorServicoID,Nome")] DiretorServico diretorServico)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("DiretorServicoID,Nome")] DiretorServico diretorServico)
        {
